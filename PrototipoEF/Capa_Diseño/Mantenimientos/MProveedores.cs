...
namespace Capa_Diseño.Mantenimientos
{
    public partial class MProveedores : Form
    {
        ...
        {
            InitializeComponent();
            scampo = logic.siguiente("proveedores", "codigo_proveedor");
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "proveedores", Txt_Codigo.Text, Txt_nombre.Text, txt_Direccion.Text, txt_tel.Text, txt_nit.Text, Cbo_estado.Text };
                string[] campos = { "codigo_proveedor", "nombre_proveedor", "direccion_proveedor", "telefono_proveedor", "nit_proveedor", "estatus_proveedor" };
        ...
        private void Btn_borrar_Click(object sender, EventArgs e)
        {
            ComboBox[] comboBox = { Cbo_estado };
            TextBox[] txtBox = { Txt_Codigo, Txt_nombre, txt_Direccion, txt_tel, txt_nit };
            string[] valores = { "proveedores", Txt_Codigo.Text, "codigo_proveedor" };
        ...
        {
            CProveedores ruta = new CProveedores();
            ruta.ShowDialog();
