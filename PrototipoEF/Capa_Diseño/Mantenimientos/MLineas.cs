...
{
    public partial class MLineas : Form
    {
        ...
        {
            InitializeComponent();
            scampo = logic.siguiente("lineas", "codigo_linea");
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "lineas", Txt_Codigo.Text, Txt_nombre.Text, Cbo_estado.Text };
                string[] campos = { "codigo_linea", "nombre_linea", "estatus_linea" };
        ...
        private void Btn_borrar_Click(object sender, EventArgs e)
        {
            ComboBox[] comboBox = { Cbo_estado };
            TextBox[] txtBox = { Txt_Codigo, Txt_nombre };
            string[] valores = { "lineas", Txt_Codigo.Text, "codigo_linea" };
