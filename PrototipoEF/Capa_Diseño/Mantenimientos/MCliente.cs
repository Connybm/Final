...
namespace Capa_Diseño.Mantenimientos
{
    public partial class MCliente : Form
    {
        ...
        void bloquearTXT()
        {
            TextBox[] txtBox = { Txt_Codigo, Txt_nombre, txt_Direccion, txt_tel, txt_nit, txt_ven };
        ...
        {
            CVendedores concep = new CVendedores();
            concep.ShowDialog();
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "clientes", Txt_Codigo.Text, Txt_nombre.Text, txt_Direccion.Text, txt_tel.Text, txt_nit.Text, txt_ven.Text, Cbo_estado.Text };
