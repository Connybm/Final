...
{
    public partial class MBodega : Form
    {
        ...
        {
            InitializeComponent();
            scampo = logic.siguiente("bodegas", "codigo_bodega");
        ...
        private void Btn_editar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string[] valores = { "bodegas", Txt_Codigo.Text, Txt_nombre.Text, Cbo_estado.Text };
                string[] campos = { "codigo_bodega", "nombre_bodega", "estatus_bodega" };
        ...
        private void Btn_borrar_Click(object sender, EventArgs e)
        {
            ComboBox[] comboBox = { Cbo_estado };
            TextBox[] txtBox = { Txt_Codigo, Txt_nombre };
            string[] valores = { "bodegas", Txt_Codigo.Text, "codigo_bodega" };
